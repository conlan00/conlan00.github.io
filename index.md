...
@media (max-width: 768px) {
  .hero {
    height: calc(100vh - 56px); /* dopasowanie do mniejszego headera */
    padding: 20px;
  }

  .glass {
    padding: 40px 20px; /* mniejszy padding w boxie */
  }

  .typing {
    font-size: 18px; /* skalowanie tekstu */
  }
